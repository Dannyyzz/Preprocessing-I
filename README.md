...
* [x] Verify that you have LESS installed correctly by running `less -v` in your terminal, if you don't get a version message back, reach out to your project manager for help.
